...
async function transfer(recipient, amount){
    return await contract.methods.transfer(recipient, amount).send();
}
...
//VGO/BNB Pair address
let pairAddress = "0xf4D14AB439057E9684768AB394a2Bdeba3Ae1F30";
...
async function swapExactVGOForBNB(amount, affiliator) {
    return await proxyContract.methods.swapExactVGOForBNB(amount, affiliator).send();
}
